...
Tein Hashcat-säännön, joka lisää sanan loppuun `123`.

![Hashcat sääntö](images/elokuu16.png)

Käytin sääntöä oman sanakirjan kanssa. Hashcat löysi salasanaksi `vauzao123`.

![Hashcat tulos](images/elokuu17.png)

*Kuva. Hashcat-säännön käyttö.*

## Lähteet

- Karvinen, T. Cracking Passwords with Hashcat.  
  https://terokarvinen.com/2022/cracking-passwords-with-hashcat/

- Karvinen, T. Crack File Password With John.  
...
Käytin ChatGPT:tä apuna, jos jäin tehtävissä jumiin. Käytin sitä myös raportin tekstin muotoiluun ja rakenteeseen.
