...
Aikaisemmassa skannauksessa kaikki 1000 TCP-porttia olivat suljettuja. Demonien käynnistämisen jälkeen kaksi porttia oli avoinna.

Ero johtuu siitä, että OpenSSH kuuntelee yhteyksiä portissa **22** ja Apache2 portissa **80**. Nmap tunnisti myös porteissa toimivat palvelut ja niiden versiot.
