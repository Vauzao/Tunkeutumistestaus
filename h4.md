...
- `alert("Hei Tero!")` vain näyttää, että JavaScriptin suorittaminen onnistuu.
- Oikeassa hyökkäyksessä hyökkääjä voisi esimerkiksi suorittaa toimintoja käyttäjän puolesta tai lukea sivulla olevia tietoja.
- Joissain tilanteissa XSS:n avulla voidaan myös yrittää kaapata käyttäjän istunto.
