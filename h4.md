...
Muokkasin ZAPissa `filename`-parametrin.
...
- Ohitin tehtävän. en saanut tehtyä
...
- Avasin käyttäjän chatin ja latasin keskustelun.
- Muutin pyynnössä tiedoston `2.txt` → `1.txt`.
- Lähetin pyynnön uudelleen.
- Sain näkyviin toisen käyttäjän keskustelun ja salasanan.

![IDOR ZAPissa](images/zap12.png)

*Kuva. Muuttamalla tiedoston nimeä sain näkyviin toisen käyttäjän keskustelun.*
...
Käytin ChatGPT:tä raportin muotoilun ja rakenteen selkeyttämiseen. ja jos en osannut itse edetä.
